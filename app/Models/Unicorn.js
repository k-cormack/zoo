...
class Unicorn {
    constructor(name = '', sex = '', age = 0, weight, hornLength, color) { //default values can be set here
        this.name = name
        this.sex = sex
        this.age = age
        this.weight = weight || 0 //or default values can be set here ( || is the symbol for "or")
        this.hornLength = hornLength || 0
        this.color = color || ''
...
export default Unicorn //command used to "kick-out" this model/class from this file (not the file name, rather the class above.                               //Anything outside the class structure is kept private) OR can be expressed as: export {Warthog} "default"                             //replaces {}