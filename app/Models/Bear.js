...
class Bear {
    constructor(name = '', sex = '', age = 0, weight, length, furColor) { //default values can be set here
        this.name = name
        this.sex = sex
        this.age = age
...
export default Bear //command used to "kick-out" this model/class from this file (not the file name, rather the class above.                               //Anything outside the class structure is kept private) OR can be expressed as: export {Warthog} "default"                             //replaces {}