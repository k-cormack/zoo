...
class Xenarthra {
    constructor(name = '', sex = '', age = 0, weight, furColor, toeCount) { //default values can be set here
        this.name = name
        this.sex = sex
        this.age = age
        this.weight = weight || 0 //or default values can be set here ( || is the symbol for "or")
        this.furColor = furColor || ''
        this.toeCount = toeCount || 0
...
export default Xenarthra //command used to "kick-out" this model/class from this file (not the file name, rather the class above.                               //Anything outside the class structure is kept private) OR can be expressed as: export {Warthog} "default"                             //replaces {}