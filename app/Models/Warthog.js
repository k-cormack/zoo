...
class Warthog {
    constructor(name = '', sex = '', age = 0, color = '', weight, leftTuskLength = 0, rightTuskLength = 0) { //default values can be set here
        this.name = name
        this.sex = sex
        this.age = age
        this.color = color
...
export default Warthog //command used to "kick-out" this model/class from this file (not the file name, rather the class above.                               //Anything outside the class structure is kept private) OR can be expressed as: export {Warthog} "default"                             //replaces {}